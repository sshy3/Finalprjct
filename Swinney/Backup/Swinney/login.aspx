<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Swinney.login" %>
		...
		<div id="sidebar1" class="sidebar">
			...
			<div class="content">
				<form id="form1" method="post" action="#" runat="server">
					...
					<asp:TextBox id="password" cssclass="textbox" runat="server" />
					<asp:Button ID="button1" runat="server" onclick="Submit" Text="Login" />

					<button onclick="window.location = adminlogin.html" data-theme="b">Admin Login</button>
